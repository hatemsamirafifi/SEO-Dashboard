...
const dataEnv = {
  ...
  GEMINI_API_KEY: optionalSecret("GEMINI_API_KEY"),
  ANTHROPIC_API_KEY: optionalSecret("ANTHROPIC_API_KEY"),
  OLLAMA_API_KEY: optionalSecret("OLLAMA_API_KEY"),
  OPENAI_COMPATIBLE_API_KEY: optionalSecret("OPENAI_COMPATIBLE_API_KEY"),
  AI_AGENT_PROVIDER: optionalVar("AI_AGENT_PROVIDER"),
  OPENROUTER_MODEL: optionalVar("OPENROUTER_MODEL"),
  OPENAI_MODEL: optionalVar("OPENAI_MODEL"),
  GEMINI_MODEL: optionalVar("GEMINI_MODEL"),
  ANTHROPIC_MODEL: optionalVar("ANTHROPIC_MODEL"),
  OLLAMA_CLOUD_MODEL: optionalVar("OLLAMA_CLOUD_MODEL"),
  OPENAI_COMPATIBLE_MODEL: optionalVar("OPENAI_COMPATIBLE_MODEL"),
  OPENAI_COMPATIBLE_BASE_URL: optionalVar("OPENAI_COMPATIBLE_BASE_URL"),
  OLLAMA_CLOUD_BASE_URL: optionalVar("OLLAMA_CLOUD_BASE_URL"),
  AI_CREDENTIALS_ENCRYPTION_KEY: optionalSecret("AI_CREDENTIALS_ENCRYPTION_KEY"),
  AI_AGENT_MODEL: optionalVar("AI_AGENT_MODEL"),
  AI_AGENT_MAX_TOOL_CALLS: optionalVar("AI_AGENT_MAX_TOOL_CALLS"),
  AI_AGENT_MAX_STEPS: optionalVar("AI_AGENT_MAX_STEPS"),
  AI_AGENT_POLL_INITIAL_MS: optionalVar("AI_AGENT_POLL_INITIAL_MS"),
  AI_AGENT_POLL_MAX_MS: optionalVar("AI_AGENT_POLL_MAX_MS"),
  AI_AGENT_MAX_POLL_ATTEMPTS: optionalVar("AI_AGENT_MAX_POLL_ATTEMPTS"),
  AI_AGENT_TOOL_TIMEOUT_MS: optionalVar("AI_AGENT_TOOL_TIMEOUT_MS"),
